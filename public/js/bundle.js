...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); //extending the map bounds to include current location
...
var stripe = Stripe('pk_test_51HBHUABygQSV2pCOGTA3ykCuDbEO3BzK5w85IiA9yGq8nJ40Tf37Nk9Bcm4tBmVRlGebJl22IfV8jSSiDIbAnazw00Q4edJZKD');
